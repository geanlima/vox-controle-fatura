...
export interface FaturaLancamentosDialogData {
  titulo: string;
  subtitulo: string;
    ...
    <div mat-dialog-content class="dlg-content">
      <table mat-table [dataSource]="data.lancamentos" class="dlg-table">
        ...
        <ng-container matColumnDef="categoria">
          ...
          <td mat-cell *matCellDef="let item">{{ item.categoriaSugerida || 'Outros' }}</td>
        </ng-container>
...
export class FaturaLancamentosDialogComponent {
  cols = ['data', 'descricao', 'categoria', 'valor'];

  constructor(@Inject(MAT_DIALOG_DATA) public data: FaturaLancamentosDialogData) {}
